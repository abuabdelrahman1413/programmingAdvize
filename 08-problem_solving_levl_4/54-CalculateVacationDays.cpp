...
int main(void) {
    ...
    cout << "------------------------------------------------\n";
    sDate DatsVacationEnd = ReadDate();

    cout << "\n\nVacation from: " << GetDayInWeek(DayOfWeekOrder(DatsVacationStart)) << " , " << DatsVacationStart.Day << "/" << DatsVacationStart.Month << "/" << DatsVacationStart.Year << endl;
    cout << "\nVacation to: " << GetDayInWeek(DayOfWeekOrder(DatsVacationEnd)) << " , " << DatsVacationEnd.Day << "/" << DatsVacationEnd.Month << "/" << DatsVacationEnd.Year << endl;
    cout << "\n\nActual vacation days: " << NumberOfActualVacationDays(DatsVacationStart, DatsVacationEnd) << endl;
  return 0;
}
